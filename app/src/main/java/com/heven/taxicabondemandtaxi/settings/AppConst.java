...
public class AppConst {
    ...
    public static final String Server_url ="http://35.232.225.181/on_demand_taxi_webservice/";
    public static final String Server_urlMain ="http://35.232.225.181/on_demand_taxi/";
    public static final String API_GET_TOKEN = "http://35.232.225.181/on_demand_taxi_webservice/Braintree/main.php";
    public static final String API_CHECK_OUT = "http://35.232.225.181/on_demand_taxi_webservice/Braintree/checkout.php";
